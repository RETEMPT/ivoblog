...
export default function LabComments({ pageId }: { pageId?: string }) {
  ...
  }, [hasGitalkConfig, pathname, pageId]);
  ...
  return (
    <div className="w-full mt-16 relative">
      ...
      {hasGitalkConfig ? (
        ...
        <p className="relative z-10 text-center text-sm text-slate-400 dark:text-slate-500 py-8 pt-6 border-t border-slate-200/50 dark:border-slate-700/50">Comments not configured yet.</p>
      )}
