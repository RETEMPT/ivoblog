  ...
  const photoWallCard = (
    <div className="uupm-card uupm-anime-frame h-full min-h-[360px] w-full overflow-hidden rounded-3xl p-5 sm:p-8 lg:p-10">
      ...
      <div className="mt-8 grid grid-cols-1 gap-x-8 gap-y-12 sm:grid-cols-2 lg:grid-cols-3">
        <Link href="/photowall" className="group flex min-w-0 flex-col items-center">
          <div className="relative mb-6 flex aspect-[4/3] w-[85%] flex-col items-center justify-center rounded-[32px] border-4 border-dashed border-slate-300/90 bg-white/10 transition-all duration-500 hover:border-indigo-500 dark:border-slate-700 dark:bg-white/5">
            <Plus className="h-12 w-12 text-slate-400 transition-all duration-500 group-hover:rotate-90 group-hover:text-indigo-500" />
  ...
  return (
    <ToastProvider>
      <div className="uupm-stage min-h-screen relative pb-12 sm:pb-16">
        <Navbar />
        <PageTransition>
          <div className="w-full max-w-[1800px] 2xl:max-w-[2048px] mx-auto mt-24 sm:mt-28 px-4 sm:px-6 lg:px-10 2xl:px-16 relative z-10">
